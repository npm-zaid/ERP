...
const ClearanceReport = () => {
  ...
  const columns = [
    ...
    { label: 'Seal Number', field: 'sealNumber' },
    { label: 'POL', field: 'pol' },
    { label: 'POD', field: 'pod' },
    { label: 'Container Type', field: 'containerType' },
    { label: 'Consignee Notify Party', field: 'consigneeNotifyParty' },
    { label: 'Warehouse Arrival Date', field: 'warehouseArrivalDate' },
    { label: 'Cargo Storage Time', field: 'cargoStorageTime' },
    { label: 'Cargo Delivery Date', field: 'cargoDeliveryDate' },
  ...
  return (
    <TableLayout
      ...
      columns={columns}
      initialData={clearanceData}
      numericFields={numericFields}
      componentType="clearanceReport"
      showAdd={false}
      showEdit={false}
      showView={true}
      showDelete={false}
